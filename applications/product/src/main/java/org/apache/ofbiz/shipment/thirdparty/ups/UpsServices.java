...
public class UpsServices {
    ...
    public static Map<String, Object> upsShipmentConfirm(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            if (!"UPS".equals(shipmentRouteSegment.getString(x.carrierPartyId))) {
            ...
            GenericValue carrierShipmentMethod = EntityQuery.use(delegator).from("CarrierShipmentMethod").where("partyId",
                    shipmentRouteSegment.get(x.carrierPartyId), "roleTypeId", "CARRIER", "shipmentMethodTypeId", shipmentRouteSegment.get(
                     x.shipmentMethodTypeId)).queryOne();
            if (carrierShipmentMethod == null) {
                return ServiceUtil.returnError(UtilProperties.getMessage(RES_ERROR, "FacilityShipmentUpsRouteSegmentCarrierShipmentMethodNotFound",
                        UtilMisc.toMap("shipmentId", shipmentId, "shipmentRouteSegmentId", shipmentRouteSegmentId, "carrierPartyId",
                                shipmentRouteSegment.get(x.carrierPartyId), "shipmentMethodTypeId", shipmentRouteSegment.get(x.shipmentMethodTypeId)),
                        locale));
            }
            ...
            UtilXml.addChildElementValue(shipmentElement, "Description",
                    "Goods for Shipment " + shipment.get(x.shipmentId) + " from " + ordersDescription, shipmentConfirmRequestDoc);
            ...
            UtilXml.addChildElementValue(shipperElement, "Name", UtilValidate.isNotEmpty(originPostalAddress.getString(x.toName))
                    ? originPostalAddress.getString(x.toName) : "", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipperElement, "AttentionName", UtilValidate.isNotEmpty(originPostalAddress.getString(x.attnName))
                    ? originPostalAddress.getString(x.attnName) : "", shipmentConfirmRequestDoc);
            ...
            UtilXml.addChildElementValue(shipperAddressElement, "AddressLine1", originPostalAddress.getString(x.address1), shipmentConfirmRequestDoc);
            if (UtilValidate.isNotEmpty(originPostalAddress.getString(x.address2))) {
                UtilXml.addChildElementValue(shipperAddressElement, "AddressLine2", originPostalAddress.getString(x.address2),
                        shipmentConfirmRequestDoc);
            }
            UtilXml.addChildElementValue(shipperAddressElement, "City", originPostalAddress.getString(x.city), shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipperAddressElement, "StateProvinceCode", originPostalAddress.getString(x.stateProvinceGeoId),
                    shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipperAddressElement, "PostalCode", originPostalAddress.getString(x.postalCode), shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipperAddressElement, "CountryCode", originCountryGeo.getString(x.geoCode), shipmentConfirmRequestDoc);
            ...
            UtilXml.addChildElementValue(shipToElement, "CompanyName", UtilValidate.isNotEmpty(destPostalAddress.getString(x.toName))
                    ? destPostalAddress.getString(x.toName) : "", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipToElement, "AttentionName", UtilValidate.isNotEmpty(destPostalAddress.getString(x.attnName))
                    ? destPostalAddress.getString(x.attnName) : "", shipmentConfirmRequestDoc);
            ...
            UtilXml.addChildElementValue(shipToAddressElement, "AddressLine1", destPostalAddress.getString(x.address1), shipmentConfirmRequestDoc);
            if (UtilValidate.isNotEmpty(destPostalAddress.getString(x.address2))) {
                UtilXml.addChildElementValue(shipToAddressElement, "AddressLine2", destPostalAddress.getString(x.address2),
                        shipmentConfirmRequestDoc);
            }
            UtilXml.addChildElementValue(shipToAddressElement, "City", destPostalAddress.getString(x.city), shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipToAddressElement, "StateProvinceCode", destPostalAddress.getString(x.stateProvinceGeoId),
                    shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipToAddressElement, "PostalCode", destPostalAddress.getString(x.postalCode), shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipToAddressElement, "CountryCode", destCountryGeo.getString(x.geoCode), shipmentConfirmRequestDoc);
            ...
            UtilXml.addChildElementValue(shipFromElement, "CompanyName", originPostalAddress.getString(x.toName), shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipFromElement, "AttentionName", originPostalAddress.getString(x.attnName), shipmentConfirmRequestDoc);
            ...
            UtilXml.addChildElementValue(shipFromAddressElement, "AddressLine1", originPostalAddress.getString(x.address1),
                    shipmentConfirmRequestDoc);
            if (UtilValidate.isNotEmpty(originPostalAddress.getString(x.address2))) {
                UtilXml.addChildElementValue(shipFromAddressElement, "AddressLine2", originPostalAddress.getString(x.address2),
                        shipmentConfirmRequestDoc);
            }
            UtilXml.addChildElementValue(shipFromAddressElement, "City", originPostalAddress.getString(x.city), shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipFromAddressElement, "StateProvinceCode", originPostalAddress.getString(x.stateProvinceGeoId),
                    shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipFromAddressElement, "PostalCode", originPostalAddress.getString(x.postalCode),
                    shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipFromAddressElement, "CountryCode", originCountryGeo.getString(x.geoCode), shipmentConfirmRequestDoc);

            // Child of Shipment: SoldTo
            Element soldToElement = UtilXml.addChildElement(shipmentElement, "SoldTo", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(soldToElement, "CompanyName", UtilValidate.isNotEmpty(destPostalAddress.getString(x.toName))
                    ? destPostalAddress.getString(x.toName) : "", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(soldToElement, "AttentionName", UtilValidate.isNotEmpty(destPostalAddress.getString(x.attnName))
                    ? destPostalAddress.getString(x.attnName) : "", shipmentConfirmRequestDoc);
            if (UtilValidate.isNotEmpty(destPhoneNumber)) {
            ...
            UtilXml.addChildElementValue(soldToAddressElement, "AddressLine1", destPostalAddress.getString(x.address1), shipmentConfirmRequestDoc);
            if (UtilValidate.isNotEmpty(destPostalAddress.getString(x.address2))) {
                UtilXml.addChildElementValue(soldToAddressElement, "AddressLine2", destPostalAddress.getString(x.address2),
                        shipmentConfirmRequestDoc);
            }
            UtilXml.addChildElementValue(soldToAddressElement, "City", destPostalAddress.getString(x.city), shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(soldToAddressElement, "StateProvinceCode", destPostalAddress.getString(x.stateProvinceGeoId),
                    shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(soldToAddressElement, "PostalCode", destPostalAddress.getString(x.postalCode), shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(soldToAddressElement, "CountryCode", destCountryGeo.getString(x.geoCode), shipmentConfirmRequestDoc);
            ...
            if (internationalServiceCodes.contains(carrierServiceCode)) {
                ...
                for (GenericValue shipmentItem : shipmentItems) {
                    ...
                    UtilXml.addChildElementValue(unitElement, "Value", orderItem.getBigDecimal(x.unitPrice).toString(), shipmentConfirmRequestDoc);
            ...
            while (shipmentPackageRouteSegIter.hasNext()) {
                ...
                List<GenericValue> carrierShipmentBoxTypes = shipmentPackage.getRelated(x.CarrierShipmentBoxType, UtilMisc.toMap("partyId", "UPS"),
                        null, false);
                ...
                if (carrierShipmentBoxType != null && carrierShipmentBoxType.get(x.packagingTypeCode) != null) {
                    UtilXml.addChildElementValue(packagingTypeElement, "Code", carrierShipmentBoxType.getString(x.packagingTypeCode),
                            shipmentConfirmRequestDoc);
                } else {
                ...
                if (shipmentBoxType != null) {
                    ...
                    UtilXml.addChildElementValue(dimensionsElement, "Length", "" + shipmentPackage.getBigDecimal(x.boxLength).intValue(),
                            shipmentConfirmRequestDoc);
                    UtilXml.addChildElementValue(dimensionsElement, "Width", "" + shipmentPackage.getBigDecimal(x.boxWidth).intValue(),
                            shipmentConfirmRequestDoc);
                    UtilXml.addChildElementValue(dimensionsElement, "Height", "" + shipmentPackage.getBigDecimal(x.boxHeight).intValue(),
                            shipmentConfirmRequestDoc);
                }
                ...
                if (!internationalServiceCodes.contains(carrierServiceCode)) {
                    ...
                    UtilXml.addChildElementValue(referenceNumberElement, "Value", shipmentPackage.getString(x.shipmentPackageSeqId),
                            shipmentConfirmRequestDoc);
                }
                if (carrierShipmentBoxType != null && carrierShipmentBoxType.get(x.oversizeCode) != null) {
                    UtilXml.addChildElementValue(packageElement, "OversizePackage", carrierShipmentBoxType.getString(x.oversizeCode),
                            shipmentConfirmRequestDoc);
                }
                ...
                if (allowCOD) {
                    ...
                    Map<String, Object> getPackageValueResult = dispatcher.runSync("getShipmentPackageValueFromOrders", UtilMisc.toMap("shipmentId",
                            shipmentId, "shipmentPackageSeqId", shipmentPackage.get(x.shipmentPackageSeqId), "currencyUomId", currencyCode,
            ...
            if (UtilValidate.isNotEmpty(totalCurrencyCode)) {
                if (UtilValidate.isEmpty(shipmentRouteSegment.getString(x.currencyUomId))) {
                    ...
                    errorList.add(UtilProperties.getMessage(RES_ERROR, "FacilityShipmentUpsCurrencyDoesNotMatch",
                            UtilMisc.toMap("currency1", totalCurrencyCode, "currency2", shipmentRouteSegment.getString(x.currencyUomId)), locale));
                }
            }
    ...
    public static Map<String, Object> upsShipmentAccept(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            // add ShipmentRouteSegment carrierServiceStatusId, check before all UPS services
            if (!"SHRSCS_CONFIRMED".equals(shipmentRouteSegment.getString(x.carrierServiceStatusId))) {
            ...
            UtilXml.addChildElementValue(shipmentAcceptRequestElement, "ShipmentDigest", shipmentRouteSegment.getString(x.trackingDigest),
    ...
    public static Map<String, Object> handleUpsShipmentAcceptResponse(Document shipmentAcceptResponseDocument, GenericValue shipmentRouteSegment,
        ...
        if ("1".equals(responseStatusCode)) {
            ...
            for (Element packageResultsElement : packageResultsElements) {
                ...
                shipmentPackageRouteSeg.set(x.boxNumber, "");
                ...
                try {
                    ...
                    String excErrMsg = "Error parsing the packageServiceOptionsMonetaryValue [" + packageServiceOptionsMonetaryValue + "] for "
                            + "Package [" + shipmentPackageRouteSeg.getString(x.shipmentPackageSeqId) + "]: " + e.toString();
                    Debug.logError(e, excErrMsg, MODULE);
                    errorList.add(UtilProperties.getMessage(RES_ERROR, "FacilityShipmentUpsErrorParsingServiceOptionsMonetaryValue",
                            UtilMisc.toMap("serviceOptionsMonetaryValue", serviceOptionsMonetaryValue, "errorString", e.toString()), locale));
                }
                ...
                if (shipmentUpsSaveCertificationInfo) {
                    ...
                    if (packageLabelHTMLImageStringDecoded != null) {
                        String outFileName = shipmentUpsSaveCertificationPath + "/UpsShipmentLabelHTMLImage" + shipmentRouteSegment.getString(
                                x.shipmentId) + "_" + shipmentRouteSegment.getString(x.shipmentRouteSegmentId) + "_"
                                + shipmentPackageRouteSeg.getString(x.shipmentPackageSeqId) + ".html";
                        try (FileOutputStream fileOut = new FileOutputStream(outFileName)) {
            ...
            if (shipmentPackageRouteSegIter.hasNext()) {
                ...
                while (shipmentPackageRouteSegIter.hasNext()) {
                    ...
                    errorList.add(UtilProperties.getMessage(RES_ERROR, "FacilityShipmentUpsErrorNoPackageResultsWereReturned",
                            UtilMisc.toMap("shipmentPackageSeqId", shipmentPackageRouteSeg.getString(x.shipmentPackageSeqId)), locale));
                }
            }
            ...
            if (controlLogReceiptElement != null) {
                ...
                if (fileStringDecoded != null) {
                    ...
                    shipmentRouteSegment.store();
                    String outFileName =
                            shipmentUpsSaveCertificationPath + "/HighValueReport" + shipmentRouteSegment.getString(x.shipmentId)
                                    + "_" + shipmentRouteSegment.getString(x.shipmentRouteSegmentId) + ".html";
                    try (FileOutputStream fileOut = new FileOutputStream(outFileName)) {
    ...
    public static Map<String, Object> upsVoidShipment(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            // add ShipmentRouteSegment carrierServiceStatusId, check before all UPS services
            if (!"SHRSCS_CONFIRMED".equals(shipmentRouteSegment.getString(x.carrierServiceStatusId))
                    && !"SHRSCS_ACCEPTED".equals(shipmentRouteSegment.getString(x.carrierServiceStatusId))) {
    ...
    public static Map<String, Object> upsTrackShipment(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            // add ShipmentRouteSegment carrierServiceStatusId, check before all UPS services
            if (!"SHRSCS_ACCEPTED".equals(shipmentRouteSegment.getString(x.carrierServiceStatusId))) {
            ...
            UtilXml.addChildElementValue(trackRequestElement, "ShipmentIdentificationNumber", shipmentRouteSegment.getString(x.trackingIdNumber),
                    trackRequestDoc);
 ...
 */
    ...
    public static Map<String, Object> upsRateInquire(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        Map<String, Object> cxt = UtilMisc.toMap("serviceConfigProps", context.get(x.serviceConfigProps), "upsRateInquireMode", context.get(
                x.upsRateInquireMode),
                "productStoreId", context.get(x.productStoreId), "carrierRoleTypeId", context.get(x.carrierRoleTypeId));
        cxt.put("carrierPartyId", context.get(x.carrierPartyId));
        cxt.put("shipmentMethodTypeId", context.get(x.shipmentMethodTypeId));
        cxt.put("shippingPostalCode", shipToAddress.getString(x.postalCode));
        cxt.put("shippingCountryCode", destCountryGeo.getString(x.geoCode));
        cxt.put("packageWeights", context.get(x.packageWeights));
        cxt.put("shippableItemInfo", context.get(x.shippableItemInfo));
        cxt.put("shippableTotal", context.get(x.shippableTotal));
        cxt.put("shippableQuantity", context.get(x.shippableQuantity));
        cxt.put("shippableWeight", context.get(x.shippableWeight));
        cxt.put("isResidentialAddress", context.get(x.isResidentialAddress));
        cxt.put("shipFromAddress", shipFromAddress);
        cxt.put("shipmentGatewayConfigId", context.get(x.shipmentGatewayConfigId));
        try {
    ...
    public static Map<String, Object> upsRateInquireByPostalCode(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        UtilXml.addChildElementValue(shipperAddrElement, "PostalCode", shipFromAddress.getString(x.postalCode), rateRequestDoc);
        try {
            //If the warehouse you are shipping from its located in a country other than US, you need to supply its country code to UPS
            UtilXml.addChildElementValue(shipperAddrElement, "CountryCode", shipFromAddress.getRelatedOne(x.CountryGeo, true).getString("geoCode"),
                    rateRequestDoc);
        } catch (GenericEntityException e) {
            return ServiceUtil.returnError(e.getMessage());
        }
    ...
    public static Map<String, Object> upsEmailReturnLabel(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            GenericValue carrierShipmentMethod = EntityQuery.use(delegator).from("CarrierShipmentMethod")
                    .where("partyId", shipmentRouteSegment.get(x.carrierPartyId), "roleTypeId", "CARRIER", "shipmentMethodTypeId",
                            shipmentRouteSegment.get(x.shipmentMethodTypeId))
                    .queryOne();
            if (carrierShipmentMethod == null) {
                return ServiceUtil.returnError(UtilProperties.getMessage(RES_ERROR, "FacilityShipmentUpsRouteSegmentCarrierShipmentMethodNotFound",
                        UtilMisc.toMap("shipmentId", shipmentId, "shipmentRouteSegmentId", shipmentRouteSegmentId, "carrierPartyId",
            ...
            Map<String, Object> destEmail = dispatcher.runSync("getPartyEmail", UtilMisc.toMap("partyId", shipment.get(x.partyIdTo), "userLogin",
                    userLogin));
            ...
            Map<String, Object> originEmail = dispatcher.runSync("getPartyEmail", UtilMisc.toMap("partyId", shipment.get(x.partyIdFrom),
                    "userLogin", userLogin));
            ...
            // Top Level Element: Shipment
            Element shipmentElement = UtilXml.addChildElement(shipmentConfirmRequestElement, "Shipment", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipmentElement, "Description", "Goods for Shipment " + shipment.get(x.shipmentId),
                    shipmentConfirmRequestDoc);
            ...
            // Child of Shipment: ShipFrom
            Element shipFromElement = UtilXml.addChildElement(shipmentElement, "ShipFrom", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipFromElement, "CompanyName", UtilValidate.isNotEmpty(originPostalAddress.getString(x.toName))
                    ? originPostalAddress.getString(x.toName) : "", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipFromElement, "AttentionName", UtilValidate.isNotEmpty(originPostalAddress.getString(x.attnName))
                    ? originPostalAddress.getString(x.attnName) : "", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipFromElement, "PhoneNumber", originPhoneNumber, shipmentConfirmRequestDoc);
            Element shipFromAddressElement = UtilXml.addChildElement(shipFromElement, "Address", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(shipFromAddressElement, "AddressLine1", originPostalAddress.getString(x.address1),
            ...
            // Child of Shipment: Service
            Element serviceElement = UtilXml.addChildElement(shipmentElement, "Service", shipmentConfirmRequestDoc);
            UtilXml.addChildElementValue(serviceElement, "Code", carrierShipmentMethod.getString(x.carrierServiceCode), shipmentConfirmRequestDoc);
            ...
            UtilXml.addChildElementValue(emailMessageElement, "FromName", UtilValidate.isNotEmpty(originPostalAddress.getString(x.attnName))
                    ? originPostalAddress.getString(x.attnName) : "", shipmentConfirmRequestDoc);
    ...
    public static Map<String, Object> upsShipmentAlternateRatesInquiry(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            Element shipperElement = UtilXml.addChildElement(shipmentElement, "Shipper", rateRequestDoc);
            UtilXml.addChildElementValue(shipperElement, "Name", UtilValidate.isNotEmpty(originPostalAddress.getString(x.toName))
                    ? originPostalAddress.getString(x.toName) : "", rateRequestDoc);
            UtilXml.addChildElementValue(shipperElement, "AttentionName", UtilValidate.isNotEmpty(originPostalAddress.getString(x.attnName))
                    ? originPostalAddress.getString(x.attnName) : "", rateRequestDoc);
            ...
            UtilXml.addChildElementValue(shipperAddressElement, "AddressLine1", originPostalAddress.getString(x.address1), rateRequestDoc);
            if (UtilValidate.isNotEmpty(originPostalAddress.getString(x.address2))) {
                UtilXml.addChildElementValue(shipperAddressElement, "AddressLine2", originPostalAddress.getString(x.address2), rateRequestDoc);
            }

            UtilXml.addChildElementValue(shipperAddressElement, "City", originPostalAddress.getString(x.city), rateRequestDoc);
            UtilXml.addChildElementValue(shipperAddressElement, "StateProvinceCode", originPostalAddress.getString(x.stateProvinceGeoId),
                    rateRequestDoc);
            UtilXml.addChildElementValue(shipperAddressElement, "PostalCode", originPostalAddress.getString(x.postalCode), rateRequestDoc);
            UtilXml.addChildElementValue(shipperAddressElement, "CountryCode", originCountryGeo.getString(x.geoCode), rateRequestDoc);

            // Child of Shipment: ShipTo
            Element shipToElement = UtilXml.addChildElement(shipmentElement, "ShipTo", rateRequestDoc);
            UtilXml.addChildElementValue(shipToElement, "CompanyName", UtilValidate.isNotEmpty(destPostalAddress.getString(x.toName))
                    ? destPostalAddress.getString(x.toName) : "", rateRequestDoc);
            UtilXml.addChildElementValue(shipToElement, "AttentionName", UtilValidate.isNotEmpty(destPostalAddress.getString(x.attnName))
                    ? destPostalAddress.getString(x.attnName) : "", rateRequestDoc);
            if (UtilValidate.isNotEmpty(destPhoneNumber)) {
            ...
            UtilXml.addChildElementValue(shipToAddressElement, "AddressLine1", destPostalAddress.getString(x.address1), rateRequestDoc);
            if (UtilValidate.isNotEmpty(destPostalAddress.getString(x.address2))) {
                UtilXml.addChildElementValue(shipToAddressElement, "AddressLine2", destPostalAddress.getString(x.address2), rateRequestDoc);
            }

            UtilXml.addChildElementValue(shipToAddressElement, "City", destPostalAddress.getString(x.city), rateRequestDoc);
            UtilXml.addChildElementValue(shipToAddressElement, "StateProvinceCode", destPostalAddress.getString(x.stateProvinceGeoId),
                    rateRequestDoc);
            UtilXml.addChildElementValue(shipToAddressElement, "PostalCode", destPostalAddress.getString(x.postalCode), rateRequestDoc);
            UtilXml.addChildElementValue(shipToAddressElement, "CountryCode", destCountryGeo.getString(x.geoCode), rateRequestDoc);
            if (UtilValidate.isNotEmpty(shipmentRouteSegment.getString(x.homeDeliveryType))) {
            ...
            UtilXml.addChildElementValue(shipFromAddressElement, "AddressLine1", originPostalAddress.getString(x.address1), rateRequestDoc);
            if (UtilValidate.isNotEmpty(originPostalAddress.getString(x.address2))) {
                UtilXml.addChildElementValue(shipFromAddressElement, "AddressLine2", originPostalAddress.getString(x.address2), rateRequestDoc);
            }
            UtilXml.addChildElementValue(shipFromAddressElement, "City", originPostalAddress.getString(x.city), rateRequestDoc);
            UtilXml.addChildElementValue(shipFromAddressElement, "StateProvinceCode", originPostalAddress.getString(x.stateProvinceGeoId),
                    rateRequestDoc);
            UtilXml.addChildElementValue(shipFromAddressElement, "PostalCode", originPostalAddress.getString(x.postalCode), rateRequestDoc);
            UtilXml.addChildElementValue(shipFromAddressElement, "CountryCode", originCountryGeo.getString(x.geoCode), rateRequestDoc);
            ...
            for (GenericValue shipmentPackageRouteSeg : shipmentPackageRouteSegs) {
                ...
                if (carrierShipmentBoxType != null && carrierShipmentBoxType.get(x.packagingTypeCode) != null) {
                    UtilXml.addChildElementValue(packagingTypeElement, "Code", carrierShipmentBoxType.getString(x.packagingTypeCode), rateRequestDoc);
                } else {
                    // default to "02", plain old Package
            ...
            try {
                ...
                for (GenericValue productStoreShipmentMethod : productStoreShipmentMethods) {
                    if ("UPS".equals(productStoreShipmentMethod.get(x.partyId))) {
                        Map<String, Object> thisUpsRateCodeMap = new HashMap<>();
                        carrierShipmentMethod = EntityQuery.use(delegator).from("CarrierShipmentMethod")
                                .where("shipmentMethodTypeId", productStoreShipmentMethod.getString(x.shipmentMethodTypeId), "partyId",
                                        productStoreShipmentMethod.getString(x.partyId), "roleTypeId",
                                        productStoreShipmentMethod.getString(x.roleTypeId))
                                .queryOne();
