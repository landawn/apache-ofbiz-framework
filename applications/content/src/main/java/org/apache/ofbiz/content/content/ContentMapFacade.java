...
public class ContentMapFacade implements Map<Object, Object> {
    ...
    public ContentMapFacade(LocalDispatcher dispatcher, GenericValue content, Map<String, Object> context, Locale locale,
        ...
        this.cache = cache;
        this.contentId = content.getString(x.contentId);
    ...
    public Object get(Object obj) {
        ...
        if ("fields".equalsIgnoreCase(name)) {
            ...
            RequestHandler rh = (RequestHandler) this.context.get(x._REQUEST_HANDLER_);
            HttpServletRequest request = (HttpServletRequest) this.context.get(x.request);
            HttpServletResponse response = (HttpServletResponse) this.context.get(x.response);
                ...
                if (webSiteId != null && delegator != null) {
                    try {
                        ...
                        if (webSitePathAlias != null) {
                            contentUri = webSitePathAlias.getString(x.pathAlias);
                        }
                    } catch (GenericEntityException e) {
                        Debug.logError(e, MODULE);
                    }
            ...
            if (subs != null) {
                for (GenericValue v: subs) {
                    subContent.add(new ContentMapFacade(dispatcher, v.getString(x.contentId), context, locale, mimeType, cache));
                }
            }
            return subContent;
    ...
    class Content extends AbstractInfo {
        ...
        public Object get(Object key) {
            ...
            if (content != null) {
                return new ContentMapFacade(dispatcher, content.getString(x.contentId), context, locale, mimeType, cache);
            }
    ...
    class SubContent extends AbstractInfo {
        ...
        public Object get(Object key) {
            ...
            if (sub != null) {
                return new ContentMapFacade(dispatcher, sub.getString(x.contentId), context, locale, mimeType, cache);
            }
    ...
    class DataResource extends AbstractInfo {
        ...
        public Object get(Object key) {
            ...
            if ("fields".equalsIgnoreCase(name)) {
                ...
                try {
                    dr = value.getRelatedOne(x.DataResource, cache);
                } catch (GenericEntityException e) {
                    Debug.logError(e, MODULE);
                }
                return dr;
                ...
                try {
                    return DataResourceWorker.renderDataResourceAsText(dispatcher, delegator, value.getString(x.dataResourceId),
