...
public class MacroScreenViewHandler extends AbstractViewHandler {
    ...
    private ScreenStringRenderer loadRenderers(HttpServletRequest request, HttpServletResponse response,
        ...
        if (UtilValidate.isNotEmpty(formMacroLibraryPath)) {
            ...
            context.put(x.formStringRenderer, formStringRenderer);
        }
        if (UtilValidate.isNotEmpty(treeMacroLibraryPath)) {
            ...
            context.put(x.treeStringRenderer, treeStringRenderer);
        }
        if (UtilValidate.isNotEmpty(menuMacroLibraryPath)) {
            ...
            context.put(x.menuStringRenderer, menuStringRenderer);
        }
    ...
    public void render(String name, String page, String info, String contentType, String encoding, HttpServletRequest request,
        ...
        try {
            ...
            context.put(x.screens, screens);
            context.put(x.simpleEncoder, UtilCodec.getEncoder(visualTheme.getModelTheme().getEncoder(getName())));
