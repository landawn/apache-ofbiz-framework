...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleApiException(ApiException e) {
        return ApiResponseBuilder.error(e.getStatus(), e.getMessage(), e.getDetail());
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<Map<String, Object>> handleUnhandledException(Exception e) {
        return ApiResponseBuilder.error(HttpStatus.INTERNAL_SERVER_ERROR, "Unexpected server error", e.getMessage());
    }
}
