...
public class SaveLabelsToXmlFile {
    ...
    public static Map<String, Object> saveLabelsToXmlFile(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        String key = (String) context.get(x.key);
        String keyComment = (String) context.get(x.keyComment);
        String updateLabel = (String) context.get(x.update_label);
        String confirm = (String) context.get(x.confirm);
        String removeLabel = (String) context.get(x.removeLabel);
        List<String> localeNames = UtilGenerics.cast(context.get(x.localeNames));
        List<String> localeValues = UtilGenerics.cast(context.get(x.localeValues));
        List<String> localeComments = UtilGenerics.cast(context.get(x.localeComments));
